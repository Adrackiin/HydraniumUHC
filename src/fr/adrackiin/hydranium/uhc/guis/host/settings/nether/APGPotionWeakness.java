...
public class APGPotionWeakness extends APGuiListener  implements APGCloseCustom {

    private APGui gui;
    private final Settings settings = Game.getGame().getSettings();
    private final HashMap<Byte, Boolean> back = new HashMap<>();
    private final PotionType type = PotionType.WEAKNESS;

    public APGPotionWeakness() {
        ...
        this.gui = new APGui("§cPotion de Faiblesse", (byte)4, new APGuiItem[]{
        ...
        parent.addChildren(this.gui, (byte)40);
    }
    ...
    private void validate(){
        ...
        gui.getParent().getItem((byte)40).setDescription(Collections.singletonList(getDescParent()));
        gui.getParent().update((byte)40);
    }
