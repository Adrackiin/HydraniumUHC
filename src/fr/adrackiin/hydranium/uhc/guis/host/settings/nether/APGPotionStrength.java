...
public class APGPotionStrength extends APGuiListener implements APGCloseCustom {

    private APGui gui;
    private final Settings settings = Game.getGame().getSettings();
    private final HashMap<Byte, Boolean> back = new HashMap<>();
    private final PotionType type = PotionType.STRENGTH;

    public APGPotionStrength() {
        ...
        this.gui = new APGui("§cPotion de Force", (byte)4, new APGuiItem[]{
        ...
        parent.addChildren(this.gui, (byte)29);
    }
    ...
    private void validate(){
        ...
        gui.getParent().getItem((byte)29).setDescription(Collections.singletonList(getDescParent()));
        gui.getParent().update((byte)29);
    }
