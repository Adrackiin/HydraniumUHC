...
public class APGPotionSlowness extends APGuiListener implements APGCloseCustom {

    private APGui gui;
    private final Settings settings = Game.getGame().getSettings();
    private final HashMap<Byte, Boolean> back = new HashMap<>();
    private final PotionType type = PotionType.SLOWNESS;

    public APGPotionSlowness() {
        ...
        this.gui = new APGui("§cPotion de Lenteur", (byte)4, new APGuiItem[]{
        ...
        parent.addChildren(this.gui, (byte)38);
    }
    ...
    private void validate(){
        ...
        gui.getParent().getItem((byte)38).setDescription(Collections.singletonList(getDescParent()));
        gui.getParent().update((byte)38);
    }
