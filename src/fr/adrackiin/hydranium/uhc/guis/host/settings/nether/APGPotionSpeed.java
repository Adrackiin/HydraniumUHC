...
public class APGPotionSpeed extends APGuiListener implements APGCloseCustom {

    private APGui gui;
    private final Settings settings = Game.getGame().getSettings();
    private final HashMap<Byte, Boolean> back = new HashMap<>();
    private final PotionType type = PotionType.SPEED;

    public APGPotionSpeed() {
        ...
        this.gui = new APGui("§cPotion de Vitesse", (byte)4, new APGuiItem[]{
        ...
        parent.addChildren(this.gui, (byte)28);
    }
    ...
    private void validate(){
        ...
        gui.getParent().getItem((byte)28).setDescription(Collections.singletonList(getDescParent()));
        gui.getParent().update((byte)28);
    }
