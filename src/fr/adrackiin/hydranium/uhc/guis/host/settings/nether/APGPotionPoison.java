...
public class APGPotionPoison extends APGuiListener implements APGCloseCustom {

    private APGui gui;
    private final Settings settings = Game.getGame().getSettings();
    private final HashMap<Byte, Boolean> back = new HashMap<>();
    private final PotionType type = PotionType.POISON;

    public APGPotionPoison() {
        ...
        this.gui = new APGui("§cPotion de Poison", (byte)4, new APGuiItem[]{
        ...
        parent.addChildren(this.gui, (byte)39);
    }
    ...
    private void validate(){
        ...
        gui.getParent().getItem((byte)39).setDescription(Collections.singletonList(getDescParent()));
        gui.getParent().update((byte)39);
    }
