...
public class APGPotionHeal extends APGuiListener implements APGCloseCustom {

    private APGui gui;
    private final Settings settings = Game.getGame().getSettings();
    private final HashMap<Byte, Boolean> back = new HashMap<>();
    private final PotionType type = PotionType.INSTANT_HEAL;

    public APGPotionHeal() {
        ...
        this.gui = new APGui("§cPotion de Soin", (byte)3, new APGuiItem[]{
        ...
        parent.addChildren(this.gui, (byte)37);
    }
    ...
    private void validate(){
        ...
        gui.getParent().getItem((byte)37).setDescription(Collections.singletonList(getDescParent()));
        gui.getParent().update((byte)37);
    }
