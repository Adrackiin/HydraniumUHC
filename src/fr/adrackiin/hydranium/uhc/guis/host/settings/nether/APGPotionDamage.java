...
public class APGPotionDamage extends APGuiListener implements APGCloseCustom {

    private APGui gui;
    private final Settings settings = Game.getGame().getSettings();
    private final HashMap<Byte, Boolean> back = new HashMap<>();
    private final PotionType type = PotionType.INSTANT_DAMAGE;

    public APGPotionDamage() {
        ...
        this.gui = new APGui("§cPotion de Dégâts", (byte)3, new APGuiItem[]{
        ...
        parent.addChildren(this.gui, (byte)41);
    }
    ...
    private void validate(){
        ...
        gui.getParent().getItem((byte)41).setDescription(Collections.singletonList(getDescParent()));
        gui.getParent().update((byte)41);
    }
